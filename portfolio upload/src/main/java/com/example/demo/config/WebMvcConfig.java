...
public class WebMvcConfig implements WebMvcConfigurer {
	...
	public void addInterceptors(InterceptorRegistry registry) {
		...
		.excludePathPatterns("/member/findLoginPasswd").excludePathPatterns("/member/doFindLoginPasswd")
		.excludePathPatterns("/member/findLoginId").excludePathPatterns("/member/doFindLoginId")
		.excludePathPatterns("/common/js").excludePathPatterns("/home/main")
		.excludePathPatterns("/member/afterJoin");
